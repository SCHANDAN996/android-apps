...
void main() {
  group('शहरों की सूची', () {
    ...
    // एक ही नाम दो राज्यों में हो सकता है और सचमुच होता है —
    // बलरामपुर छत्तीसगढ़ में भी है और उत्तर प्रदेश में भी। सूची में
    // राज्य नीचे लिखा दिखता है और खोज उसे भी पढ़ती है, इसलिए भ्रम
    // नहीं होता। जो नहीं होना चाहिए वो है **एक ही राज्य में एक ही
    // नाम दो बार** — वो नक़ल की ग़लती है।
    test('एक राज्य में एक ही नाम दो बार नहीं', () {
      final jode = indianCities.map((c) => '${c.state}|${c.name}').toList();
      expect(jode.toSet().length, jode.length,
          reason: 'एक ही राज्य में वही नाम दो बार है');
    });
    ...
    // ⚠️ यही वो शिकायत थी जो फ़ोन पर दिखी — छत्तीसगढ़ में बैठे यूज़र
    // का संकल्प "भद्राचलम, तेलंगाना" बोल रहा था, क्योंकि सुकमा-बीजापुर
    // की तरफ़ का कोई शहर सूची में था ही नहीं और सबसे नज़दीक सरहद पार
    // वाला निकल आया।
    //
    // इसलिए अब पूरे राज्य के **तैंतीसों ज़िला-मुख्यालय** सूची में हैं।
    // (गणित इससे नहीं बदलता — फ़ोन से पहचानी जगह के अक्षांश-देशांतर
    // फ़ोन के ही रहते हैं, सिर्फ़ नाम पास वाले शहर से आता है।)
    test('छत्तीसगढ़ के तैंतीसों ज़िला-मुख्यालय सूची में हैं', () {
      final naam = indianCities
          .where((c) => c.state == 'छत्तीसगढ़')
          .map((c) => c.name)
          .toSet();
      const mukhyalay = [
        'बालोद', 'बलौदाबाजार', 'बलरामपुर', 'जगदलपुर', 'बेमेतरा',
        'बीजापुर', 'बिलासपुर', 'दंतेवाड़ा', 'धमतरी', 'दुर्ग',
        'गरियाबंद', 'गौरेला', 'जांजगीर', 'जशपुरनगर', 'कवर्धा',
        'कांकेर', 'कोंडागाँव', 'कोरबा', 'बैकुंठपुर', 'खैरागढ़',
        'महासमुंद', 'मनेंद्रगढ़', 'मोहला', 'मुंगेली', 'नारायणपुर',
        'रायगढ़', 'रायपुर', 'राजनांदगाँव', 'सक्ती', 'सारंगढ़',
        'सूरजपुर', 'अंबिकापुर', 'सुकमा',
      ];
      expect(mukhyalay, hasLength(33));
      for (final m in mukhyalay) {
        expect(naam, contains(m), reason: '$m छूट गया');
      }
    });
  });
  ...
  group('सबसे नज़दीक शहर', () {
    ...
    // सुकमा में बैठे आदमी को अब सरहद पार का नाम नहीं मिलेगा।
    test('सुकमा के पास सुकमा, तेलंगाना का कोई शहर नहीं', () {
      final paas = nearestIndianCity(18.39, 81.66);
      expect(paas.name, 'सुकमा');
      expect(paas.state, 'छत्तीसगढ़');
    });
