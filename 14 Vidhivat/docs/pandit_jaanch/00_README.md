...
|---|---|---|
| `मंत्र/` | हर **अलग** मंत्र-पाठ की अपनी फ़ाइल — पाठ, अर्थ, स्रोत, दूसरा चलन, कहाँ-कहाँ चलता है | 44 |
| `संकल्प.md` | संकल्प के 14 रूप, तीन शक वाले सवालों समेत | 1 |
| `खाली-मंत्र/` | हर ख़ाली जगह की अपनी फ़ाइल — किन पूजाओं में, क्यों नहीं लिखा | 21 |
| `पूजा/` | हर पूजा की अपनी फ़ाइल — दायरा, कदम, सामग्री, स्रोत | 28 |

## संख्या में

- 28 पूजाएँ, कुल 177 जगह मंत्र आता है
- वे असल में सिर्फ़ **44 अलग पाठ** हैं (`मंत्र/` की फ़ाइलें उतनी ही हैं)
- 143 जगह भरी हुई, 34 जगह जान-बूझकर ख़ाली
