...
|---|---|---|
| `मंत्र/` | हर **अलग** मंत्र-पाठ की अपनी फ़ाइल — पाठ, अर्थ, स्रोत, दूसरा चलन, कहाँ-कहाँ चलता है | 15 |
| `संकल्प.md` | संकल्प के 14 रूप, तीन शक वाले सवालों समेत | 1 |
| `खाली-मंत्र/` | हर ख़ाली जगह की अपनी फ़ाइल — किन पूजाओं में, क्यों नहीं लिखा | 34 |
| `पूजा/` | हर पूजा की अपनी फ़ाइल — दायरा, कदम, सामग्री, स्रोत | 18 |

## संख्या में

- 18 पूजाएँ, कुल 126 जगह मंत्र आता है
- वे असल में सिर्फ़ **15 अलग पाठ** हैं (`मंत्र/` की फ़ाइलें उतनी ही हैं)
- 79 जगह भरी हुई, 47 जगह जान-बूझकर ख़ाली
