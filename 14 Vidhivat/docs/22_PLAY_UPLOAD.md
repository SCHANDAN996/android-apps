...
फ़ाइल लगभग **56 MB** दिखेगी। **यूज़र को इतना नहीं जाता।** उसमें तीनों
ABI, debug-symbols और obfuscation metadata हैं — Play हर फ़ोन को सिर्फ़
उसका हिस्सा भेजता है।
...
⛔ **`.apk` मत डालिए, `.aab` ही डालिए।** APK में तीनों ABI बिना दबे रहती
हैं और डाउनलोड 22.7 MB हो जाता है।
